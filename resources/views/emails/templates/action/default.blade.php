                                    ...
                                    <tr>
                                        <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                            ...
                                            <table style="width: 100%; margin: 30px auto; padding: 0; text-align: center;" align="center" width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td align="center">
                                                        <a href="@yield('action_button_href')" style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; display: block; display: inline-block; width: 200px; min-height: 20px; padding: 10px; background-color: #3869D4; border-radius: 3px; color: #ffffff; font-size: 15px; line-height: 25px; text-align: center; text-decoration: none; -webkit-text-size-adjust: none; background-color: #3869D4;" class="button" target="_blank">
                                                            @yield('action_button_name')
                                                        </a>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table style="margin-top: 25px; padding-top: 25px; border-top: 1px solid #EDEFF2;">
                                                <tr>
                                                    <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif;">
                                                        ...
                                                        <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;  width: 500px; overflow-wrap: break-word; word-wrap: break-word;">
                                                            <a style="color: #3869D4;" href="@yield('action_button_href')" target="_blank">
                                                                @yield('action_button_href')
                                                            </a>
                                                        </p>
                                                    </td>
                                                </tr>
                                ...
                                <table style="width: auto; max-width: 570px; margin: 0 auto; padding: 0; text-align: center;" align="center" width="570" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; color: #AEAEAE; padding: 35px; text-align: center;">
                                            <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                                &copy; 2017
                                                <a style="color: #3869D4;" href="{{ url('/') }}" target="_blank">MyEngine</a>.
                                                All rights reserved.
                                            </p>
                                        </td>
                                    </tr>
